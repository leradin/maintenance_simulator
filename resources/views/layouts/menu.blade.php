        <ul class="main">
            ...
            <li><a href="{{ url('student') }}" class="{{ Request::is('student*') ? 'active' : '' }}"><span class="icom-user3"></span><span class="text">@lang('messages.menu_student')</span></a></li>   
            <li><a href="{{ url('test') }}" class="{{ (Request::is('test*')) ? 'active' : '' }}"><span class="icom-user1"></span><span class="text">@lang('messages.menu_user')</span></a></li>
        </ul>
