<div class="block-fluid">
    <div class="form-group">
        ...
        <div class="col-md-4">
            {!! Form::textarea('description', null, array('placeholder' => 'Descripción','class' => 'form-control validate[maxSize[100]] text-input','id' => 'description')) !!}
            <span class="help-block"><small>@lang('messages.required_max_100')</small></span>
        </div> 
    </div>
    ...
    <div class="toolbar bottom TAR">
        <div class="btn-group">
            ...
            <a href="{{ url('solution') }}" class="btn btn-danger">@lang('messages.cancel')</a>
