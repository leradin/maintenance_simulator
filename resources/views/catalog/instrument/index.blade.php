...
@section('breadCrumb')
    ...
    <li>@lang('messages.title_instrument')</li>
@endsection
           ...
           @include('layouts.message') 
            <div class="widget">
                <div class="head dark">
                    ...
                    <h2>@lang('messages.title_instrument')</h2>
                    <ul class="buttons">
                        <li><a href="{{ url("instrument/create") }}" title="Crear Intrumento"><span class="icos-plus"></span></a></li>
                    </ul>                         
                </div>                
                        ...
                        <table  id="tools_table" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($instruments as $instrument)
                                    ...
                                    <td class="TAC">
                                        {!! Form::open(['route' => ['instrument.destroy',$instrument],'method' => 'DELETE','onsubmit' => "return confirm('¿Deseas eliminar este instrumento?');"]) !!}
                                            <a href="{{ route('instrument.edit',$instrument) }}" title="@lang('messages.button_edit')" class="icon-button"><span class="glyphicon glyphicon-pencil"></span></a>
