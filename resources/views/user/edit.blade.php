...
@section('breadCrumb')
    ...
    <li>@lang('messages.title_edit_user')</li>
@endsection
            ...
            @include('layouts.message')                
                <div class="widget">
                    <div class="head dark">
                        ...
                        <h2>@lang('messages.title_edit_user')</h2>
                    </div>    
                    {!! Form::model($user, ['route' => ['user.update', $user->id],'id' => 'validate', 'name' => 'validate','method' => 'put', 'role' => 'form','autocomplete' =>'off']) !!}
                        @include('user.form')
                    {!!Form::close()!!}                
                </div>
            </div>            
